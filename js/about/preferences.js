...
class PaymentsTab extends ImmutableComponent {
  ...
  get ledgerRecoveryContent () {
    return <div className='board'>
      {
        this.props.ledgerRecoverySucceeded
        ? <div>It worked</div>
        : null
      }
      {
        this.props.ledgerRecoveryFailed
        ? <div>It failed</div>
        : null
      }
    ...
    switch (this.state.preferenceTab) {
      ...
      case preferenceTabs.PAYMENTS:
        tab = <PaymentsTab settings={settings} siteSettings={siteSettings}
          ...
          ledgerRecoverySucceeded={this.state.ledgerRecoverySucceeded}
          ledgerRecoveryFailed={this.state.ledgerRecoverySucceeded}
